...
namespace SistemaVIP.API.Controllers
{
    ...
    public class ReportesController : ControllerBase
    {
        ...
        public async Task<ActionResult> GetReportePresentador(
            int presentadorId,
        ...
        [Authorize(Roles = $"{UserRoles.SUPER_ADMIN}, {UserRoles.ADMIN}")]
        public async Task<ActionResult> GetReporteTerapeuta(
            int terapeutaId,
            [FromQuery] DateTime fechaInicio,
            [FromQuery] DateTime fechaFin)
        {
        ...
        [HttpGet("servicios")]
        [Authorize(Roles = $"{UserRoles.SUPER_ADMIN}, {UserRoles.ADMIN}")]
        public async Task<ActionResult> GetReporteServicios(
            [FromQuery] DateTime fechaInicio,
            [FromQuery] DateTime fechaFin)
        {
            try
